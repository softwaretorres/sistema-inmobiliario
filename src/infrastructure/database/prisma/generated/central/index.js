...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/infrastructure/database/prisma/generated/central",
    "infrastructure/database/prisma/generated/central",
  ]
...
path.join(process.cwd(), "src/infrastructure/database/prisma/generated/central/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/infrastructure/database/prisma/generated/central/schema.prisma")
