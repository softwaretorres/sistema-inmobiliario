...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/infrastructure/database/prisma/generated/tenant",
    "infrastructure/database/prisma/generated/tenant",
  ]
...
path.join(process.cwd(), "src/infrastructure/database/prisma/generated/tenant/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/infrastructure/database/prisma/generated/tenant/schema.prisma")
